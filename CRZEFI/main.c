...
#define baseOperation 0xbeef
#define VARIABLE_NAME L"cowadlina"
...
static const EFI_GUID ProtocolGuid
	= { 0x33019999, 0xf00d, 0x2048, {0x7f, 0x1e, 0x53, 0xab, 0x7c, 0x9c, 0x12, 0xbc} };
	...
	)
{
	...
	Print(L"EFI Daemon for c0wadlina was successfully loaded! Booting to Windows 10...\n");
}
...
efi_main(IN EFI_HANDLE ImageHandle, IN EFI_SYSTEM_TABLE *SystemTable) 
{
	...
	Print(L"****************************************************\n");
	Print(L"*                                                  *\n");
	Print(L"* EFI DAEMON LOADED - YOU CAN NOW BOOT TO WINDOWS! *\n");
	Print(L"* You will see a red text when booting to Windows  *\n");
	Print(L"* If you dont, disable Secure Boot!!!              *\n");
	Print(L"*                                                  *\n");
	Print(L"* EFI Loader by: https://github.com/TheCruZ        *\n");
	Print(L"****************************************************\n");
	return EFI_SUCCESS;
}
